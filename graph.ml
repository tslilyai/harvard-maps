...
("Felix", "Gnomon", 16.);
("Felix", "Zinnia", 49.);
("Zinnia", "Adams_Claverly", 528.);
("Tennis", "Adams_Claverly", 151.);
("Tennis", "Boloco", 20.);
("Boloco", "Spice", 138.);
("Spice", "Andover", 33.);
("Andover", "Ginos", 20.);
...
("Currier","Pfoho",100.);
("Soch","Mass_hall",3168.);
("Adams_Dhall","Lampoon",203.);
("Adams_Claverly","Lampoon",117.);
("Harvard_Bookstore","Crimson",177.);
("Harvard_Bookstore","Wigglesworth",144.);
("Crimson","Adams_Dhall",92.);
("Lampoon","Quincy",161.);
("Quincy","Lev_McKinlock",476.);
("Lev_McKinlock","Lev_Towers",262.);
("Lev_Towers","Dunster",312.);
("Dunster","Mather",187.);
("Lev_McKinlock","Winthrop_Gore",322.);
("Quincy","Lowell",184.);
("Winthrop_Gore","Winthrop_Standish",377.);
("Winthrop_Standish","Eliot",187.);
("Eliot","Kirkland",128.);
("Kirkland","MAC",299.);
("MAC","Lowell",217.);
("MAC","UHS",374.);
